...
<body>
	<h1 style="color: violet; font-size: 40px;" align="center">HEY WE DEPLOYED OUR APP USING JENKINS BY KUSHA KUMAR </h1>
    ...
    <h1 style="color: grey; font-size: 40px;" align="center">WE ARE USING JENKINS AND TOMCAT</h1>
